...
class VyborPokolenie extends StatefulWidget {
  const VyborPokolenie({
    Key? key,
  ...
  @override
  State<VyborPokolenie> createState() => _VyborPokolenieState();
}

class _VyborPokolenieState extends State<VyborPokolenie> {
  @override
  void initState() {
              ...
              state is GetGenerationsLoading
                ...
                children: List.generate(
                  ...
                  (index) => GestureDetector(
                    onTap: () {
                      widget.stt(widget.paa
                          .copyWith(pokolenie: generations[index].id));
                    },
                    child: opW(
                      // optionName: widget.optionsListt[index] as String,
                      optionName: generations[index].name as String,
                      stt: widget.stt,
                    ),
                  ),
                ),
